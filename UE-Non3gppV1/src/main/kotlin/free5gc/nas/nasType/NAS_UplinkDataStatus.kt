...
class UplinkDataStatus {
    ...
    @JvmName("getIeiUplinkDataStatus")
    fun getIei(): UByte = iei

    @JvmName("setIeiUplinkDataStatus")
    fun setIei(iei: UByte) {
        this.iei = iei
    }

    @JvmName("getLenUplinkDataStatus")
    fun getLen(): UByte = len

    @JvmName("setLenUplinkDataStatus")
...
*/
    ...
    companion object {
        ...
        fun newUplinkDataStatus(iei: UByte): UplinkDataStatus {
            val uplinkDataStatus = UplinkDataStatus()
